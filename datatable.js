class SimpleDataTableWidget{
...

    {
        ...
        let dialogs = "\n" +
            ...
            "                    <label for=\"firstNameCreateInput\">Position</label>\n" +

            "                    <input required id=\"positionCreateInput\" type=\"text\" class=\"form-control\">\n" +
            ...
            "                <input required id=\"positionUpdateInput\" type=\"text\" class=\"form-control\">\n" +
        ...
        this.personFields = ['firstName','lastName','city','age','position'];
        ...
        this.createInputPosition = $('#positionCreateInput');
        ...
        this.updateInputPosition = $('#positionUpdateInput');
    ...
    createPerson(firstName, lastName, age, city, position) {
    ...
    updatePerson(key, firstName, lastName, age, city, position)
...

        {
            ...
            this.displayPersons = this.allPersons.filter( (value)=>{
                ...
                return value.city.indexOf(this.filter) !== -1
                    ...
                    || value.position.indexOf(this.filter) !== -1
...

{
    ...
    let position = datatableonj.createInputPosition.val();

    if(firstName === '' || lastName === '' || age === '' || city === '' || position === '')

        return;

    datatableonj.createPerson(firstName,lastName,parseInt(age),city,position);
    ...
    datatableonj.createInputPosition.val('');
...
function onClickUpdatePerson(event) {
	...
	datatableonj.updateInputPosition.val(datatableonj.displayPersons[index].position);
...
function onClickUpdateSavePerson(objName) {
    ...
    let position = datatableonj.updateInputPosition.val();
    ...
    datatableonj.updatePerson(key,firstName,lastName,parseInt(age),city,position);
    ...
    datatableonj.updateInputPosition.val('');
